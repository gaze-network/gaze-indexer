...
const insertttBlock = `-- name: InsertttBlock :exec
...
type InsertttBlockParams struct {
	BlockHeight   int32
	BlockHash     string
	Version       int32
	MerkleRoot    string
...
func (q *Queries) InsertttBlock(ctx context.Context, arg InsertttBlockParams) error {
	_, err := q.db.Exec(ctx, insertttBlock,
		arg.BlockHeight,
		arg.BlockHash,
		arg.Version,
		arg.MerkleRoot,
